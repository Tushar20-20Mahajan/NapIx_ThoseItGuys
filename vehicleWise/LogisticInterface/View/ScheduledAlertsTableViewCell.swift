//
//  ScheduledAlertsTableViewCell.swift
//  vehicleWise
//
...
// Custom UITableViewCell class for displaying scheduled alerts information
class ScheduledAlertsTableViewCell: UITableViewCell {
    ...
    // Function to update the view of the cell with scheduled alert information
